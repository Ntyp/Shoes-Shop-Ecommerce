...
<nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
    ...
    <section>
        <div class="container">
            <div class="row">
                <h3><u><b>ขั้นตอนการสั่งซื้อ</b></u></h3>
                <div class="col-12 mt-3">
                    <p>1. กดสมัครสมาชิก</p>
                    <img style="width:100%" src="./img/S__19218435.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>2. กรอกข้อมูลให้ครบ แล้วกด”สมัครสมาชิก”</p>
                    <img style="width:100%" src="./img/S__19218437.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>3. “เข้าสู่ระบบ” เพื่อสั่งซื้อสินค้า</p>
                    <img style="width:100%" src="./img/S__19218438.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>4. ข้าม</p>
                    <img style="width:100%" src="./img/S__19218439.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>5. เลือกเพิ่มสินค้าลงตะกร้าสินค้าแล้ว “กดสั่งซื้อ”</p>
                    <img style="width:100%" src="./img/S__19218440.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>6. ยืนยันออเดอร์ “กรอกข้อมูลการจัดส่งสินค้า” แล้วกดสั่งซื้อ</p>
                    <img style="width:100%" src="./img/S__19218441.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>7. รูปข้อ4. วงแดงที่คำว่า สถานะคำสั่งซื้อรูปที่7.กด “รายละเอียด”</p>
                    <img style="width:100%" src="./img/S__19218442.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>8. กด “ชำระเงิน”</p>
                    <img style="width:100%" src="./img/S__19218443.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>9. เลือกธนาคารที่ต้องการชำระ เลือกไฟล์รูป กด “ยืนยันการชำระเงิน”</p>
                    <img style="width:100%" src="./img/S__19218444.jpg" alt="">
                </div>
                <div class="col-12 mt-5">
                    <p>10. รอแอดมินตรวจสอบการชำระเงินและส่งเลขพัสดุให้ที่ “สถานะคำสั่งซื้อ” “รายละเอียด”</p>
                    <img style="width:100%" src="./img/S__19218445.jpg" alt="">
                </div>
