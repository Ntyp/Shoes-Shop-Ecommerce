            ...
            <div class="row">
                <div class="col-2"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <center>
                            <img width="50%" src="./img/52377.jpg" alt=""> <br>
                                <p>ไอดีผู้ใช้งาน: <b><?php echo $_SESSION['Username'] ?></b></p>
                            </center>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <form action="" method="POST">
                            <div class="row">
                                <div class="col">
                                    <span>อีเมล์</span><input class="form-control" name="user_email" id="user_email" type="text" value="<?php echo $row['User_Email']; ?>">
                                </div>
                                <div class="col">
                                    <span>เบอร์ติดต่อ</span><input class="form-control" name="user_phone" id="user_phone" type="text" value="<?php echo $row['User_Phone']; ?>">
                                </div>
                            </div>
                            
                            
                            <span>ที่อยู่</span><input class="form-control" name="user_address" id="user_address" type="text" value="<?php echo $row['User_Address']; ?>">

                            <div class="row">
                                <div class="col">
                                    <span>ตำบล</span><input class="form-control" name="user_tambon" id="user_tambon" type="text" value="<?php echo $row['User_Tambon']; ?>">
                                </div>
                                <div class="col">
                                    <span>อำเภอ</span><input class="form-control" name="user_amphoe" id="user_amphoe" type="text" value="<?php echo $row['User_Amphoe']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <span>จังหวัด</span><input class="form-control" name="user_province" id="user_province" type="text" value="<?php echo $row['User_Province']; ?>">
                                </div>
                                <div class="col">
                                    <span>รหัสไปรษณี</span><input class="form-control" name="user_zipcode" id="user_zipcode" type="text" value="<?php echo $row['User_Zipcode']; ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
