<?php
    ...
    $sql = "SELECT * FROM payment_order WHERE order_id = $order_id"; //เรียกข้อมูลมาแสดงทั้งหมด
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex">
            ...
            <li class="nav-item dropdown ">
                <a style="text-decoration:none" class="nav-link btn btn-success dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="order.php">สถานะคำสั่งซื้อ</a></li>
    ...
    <section>
        <div class="row">
            <div class="col">
                <center>
                <h3>สถานะ:</h3>
                <img src="./img/<?php $row['payment_img']; ?>" alt="">
                <p><?php $row['payment_total']; ?></p>
                <p><?php $row['payment_bank']; ?></p>
                </center>
            </div>
        </div>
    </section>
