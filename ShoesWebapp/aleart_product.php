<?php
    ...
    session_start();
    $sql = "SELECT * FROM stock_product WHERE Quatity < 10";
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                                ...
                                <td align="center">แอดชั่น</td>
                        </tr>
                        <?php
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                        ?>
                        <tr>
                            <td width='200'><img width="100%" src="img/<?php echo $row["Code"]?>.webp" alt=""></td>
                            <td align="center"><?php echo $row["Code"]?></td>
                            <td><?php echo $row["Name"]?></td>
                            <td align="center"><?php echo $row["Size"]?></td>
                            <td align="center"><?php echo $row["Color"]?></td>
                            <td align="center"><p style="color:red"><?php echo $row["Quatity"]?></p></td>
                            <td align="right"><?php echo $row["Forsell"]?></td>
                            <td align="center"><a href="stock.php">เติมสินค้า</a></td>
                        </tr>
                        <?php
                            }
                        ?>
