<?php
    ...
    $query_provinces = mysqli_query($conn,$sql_provinces);
      //connect db
    $sql = "SELECT * FROM stock WHERE Type = 'women'"; //เรียกข้อมูลมาแสดงทั้งหมด
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                   ...
                   <h5><span><b><font color="red">ราคา<?php echo $row["Forsell"]; ?>.00บาท</span> </b><br></font></h5>
                </div>
            <?php
                    }
            ?>
